...
var SIGNATURE_REGEXP = /^\(.*\) => /, convert3 = (type) => {
  ...
  switch (typeof raw < "u" && (base.raw = raw), name2) {
    case "enum": {
      let values2 = computed ? value : value.map((v2) => {
        let trimmedValue = trimQuotes(v2.value);
    ...
    case "union":
      return { ...base, name: "union", value: value.map((v2) => convert3(v2)) };
    case "instanceOf":
    case "element":
    case "elementType":
    default: {
      if ((name2 == null ? void 0 : name2.indexOf("|")) > 0)
        try {
          let literalValues = name2.split("|").map((v2) => JSON.parse(v2));
...
export {
  ...
  isObjectLike_1 as d,
  isArray_1 as e,
  enhanceArgTypes as f,
  extractComponentDescription as g,
  createSummaryValue as h,
  isObject_1 as i,
  getDocgenSection as j,
  SourceType as k,
  isFunction$3 as l,
  isTooLongForDefaultValueSummary as m,
  hasDocgen as n,
  extractComponentProps as o,
